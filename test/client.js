...
exports['estimate transaction gas for value transfer'] = async function (test) {
    test.async();
    ...
    const result = await client.estimate(1, 2, null, null, { value: 100000 });
